...
namespace Primusz.ZoomPanel
{
    ...
    /// 
    /// IScrollInfo is implemented to allow ZoomPanel to be wrapped (in XAML)
    /// in a ScrollViewer.  IScrollInfo allows the ScrollViewer and ZoomPanel to 
    ...
    public partial class ZoomPanel
    {
        ...
        /// <summary>
        /// Reference to the ScrollViewer that is wrapped (in XAML) around the ZoomPanel.
